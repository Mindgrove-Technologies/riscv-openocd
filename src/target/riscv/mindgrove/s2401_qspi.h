...
#define CR_PRESCALER(x)   ((x) << 18U)  // 8bit
#define CR_PMM(x)         ((x) << 17U)
#define CR_APMS(x)        ((x) << 16U)
#define CR_TOIE(x)        ((x) << 15U)  // 1bit
#define CR_SMIE(x)        ((x) << 14U)
#define CR_FTIE(x)        ((x) << 13U)
#define CR_TCIE(x)        ((x) << 12U)
#define CR_TEIE(x)        ((x) << 11U)
#define CR_FTHRES(x)      ((x) << 7U)  // 4bit
#define CR_FSEL(x)        ((x) << 6U)  // Not used
#define CR_DFM(x)         ((x) << 5U)  // Not used
#define CR_SSHIF(x)       ((x) << 4U)  // Not used 1bit
#define CR_TCEN(x)        ((x) << 3U)
#define CR_DMAEN(x)       ((x) << 2U)  // Not used
#define CR_ABORT(x)       ((x) << 1U)
#define CR_EN(x)          ((x) << 0U)
